...
import ru.neoflex.ndk.dsl.dictionary.{ConditionExpression, DictionaryValue}
...
final case class DictLazyCondition[T](v: DictionaryValue[T], cond: ConditionExpression[T]) extends LazyCondition {
